...
const ExerciseComponent = ({ exercise, key }) => {
      ...
      <div className="bg-gray-300 mt-5">
        ...
        <div className="bg-[#faf5e6] md:p-[40px] lg:p-[40px] p-[20px]">
          <div className="p-4 lg:p-8 border-2 bg-white rounded-xl">
            <h1 className="text-primary md:text-2xl">
              {exercise.title || "Vocabulary Exercise"}
            </h1>
            <div className="flex items-center mt-4 ml-4 gap-3 lg:text-lg">
            ...
            {exercise.questions.map((question, index) => (
              <div key={question.q_uuid}>
                ...
                {question.type === "FILL_IN_THE_BLANK" ? (
                  <>
                    {/* Display choices at the beginning of the first question if there are multiple choices */}
                    {index === 0 && question?.choices.length > 1 && (
                    ...
                    {/* Spelling question or question with voice */}
                    ...
                    {/* Standard fill-in-the-blank without voice or special conditions */}
                    {!exercise.title.toLowerCase().includes("spelling") &&
                      !question.voice && (
                        <div className="flex flex-col lg:flex-row ml-4 mt-2 lg:items-center gap-4 lg:text-xl">
                          {`${index + 1}. `}
                          {question.question_text
                            .split("#")
                            .map((part, partIndex) => (
