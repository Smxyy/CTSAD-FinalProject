export default function LoadingLessonDetail() {
  return (
    <>
    <div className="flex">
      <aside
        ...
        <div className="h-full px-4 w-[160px] overflow-y-auto bg-white pb-8 animate-pulse">
          <ul className="space-y-4">
            ...
            {Array(6).fill().map((_, index) => (
              <li key={index} className="h-[20px] bg-gray-300 rounded-md"></li>
            ))}
          </ul>
        </div>
      </aside>
        ...
        <div>
          ...
          <div className="bg-gray-300 mt-7">
            ...
            <div className="bg-[#faf5e6] md:p-[40px] lg:p-[40px] p-[20px] mt-4">
              <div className="w-full h-[250px] bg-gray-300 rounded-md"></div>
            </div>
          </div>
          ...
          <div className="mt-7">
            <div className="w-full h-[40px] bg-gray-300 rounded-md"></div>
            <div className="w-full h-[20px] bg-gray-300 rounded-md mt-4"></div>
          </div>
